...
|	Div(a1, a2) -> "(" ^ (aexpTostr a1) ^ " / " ^ (aexpTostr a2) ^ ")"
...
|	AMore(f,g) -> "(" ^ (aexpTostr f) ^ " > " ^ (aexpTostr g) ^ ")"
|	ALess(f,g) -> "(" ^ (aexpTostr f) ^ " < " ^ (aexpTostr g) ^ ")"
|	AEq(a1, a2) -> "(" ^ (aexpTostr a1) ^ " == " ^ (aexpTostr a2) ^ ")"
|	ALeq(a1, a2) -> "(" ^ (aexpTostr a1) ^ " <= " ^ (aexpTostr a2) ^ ")"
|	AMeq(a1, a2) -> "(" ^ (aexpTostr a1) ^ " >= " ^ (aexpTostr a2) ^ ")"
...
|	PMore(t1, t2) -> AMore(t1, t2)
|	PLess(t1, t2) -> ALess(t1, t2)
|	PEq(t1, t2) -> AEq(t1, t2)
|	PLeq(t1, t2) -> ALeq(t1, t2)
|	PMeq(t1, t2) -> AMeq(t1, t2)
...
|	Div(a1, a2) -> Div(asubst x a a1, asubst x a a2)
...
|	AMore(t1, t2) -> AMore(asubst x a t1, asubst x a t2)
|	ALess(t1, t2) -> ALess(asubst x a t1, asubst x a t2)
|	AEq(t1, t2) -> AEq(asubst x a t1, asubst x a t2)
|	ALeq(t1, t2) -> ALeq(asubst x a t1, asubst x a t2)
|	AMeq(t1, t2) -> AMeq(asubst x a t1, asubst x a t2)
...
Seq(Asg("a", Sum(Var("x", Progr), Num 1)),
	If(PEq(Min(Var("a", Progr), Num 1), Num 0),
		Asg("y" , Num 1), Asg("y", Var("a", Progr))));;
...
Seq(Asg("y", Num 1),
	Wh(PUneq(Var("x", Progr), Num 0),
		AEq(Mult(Var("y", Progr),Fat(Var("x",Progr))), Fat(Var("x0", Progr))),
			Seq(Asg("y", Mult(Var("y", Progr), Var("x", Progr))), Asg("x", Min(Var("x", Progr), Num 1)))));;

let sum =
Seq(Asg("z", Num 0),
	Wh(PMore(Var("x", Progr), Num 0),
		AAnd(AEq(Var("z", Progr), Min( Div(Mult(Var("x0", Progr), Sum(Var("x0", Progr), Num 1)), Num 2), Div(Mult(Var("x", Progr), Sum(Var("x", Progr), Num 1)), Num 2))), AMeq(Var("x", Progr), Num 0)),
			Seq(Asg("z", Sum(Var("z", Progr), Var("x", Progr))), Asg("x", Min(Var("x", Progr), Num 1)))));;

let copy1 =
Seq(Seq(Asg("a", Var("x", Progr)), Asg("y", Num 0)),
	Wh(PUneq(Var("a", Progr), Num 0),
		AEq(Min(Var("x", Progr), Var("y", Progr)),Min(Var("x", Progr), Var("y", Progr))),
			Seq(Asg("y", Sum(Var("y", Progr), Num 1)), Asg("a", Min(Var("a", Progr), Num 1)))));;

let mult1 =
Seq(Seq(Asg("a", Num 0), Asg("z", Num 0)),
	Wh(PUneq(Var("a", Progr), Var("z", Progr)),
		AEq(Var("z", Progr), Mult(Var("a", Progr), Var("x", Progr))),
			Seq(Asg("z", Sum(Var("z", Progr), Var("x", Progr))), Asg("a", Sum(Var("a", Progr), Num 1)))));;

let mult2 =
Seq(Asg("z", Num 0),
	Wh(PUneq(Var("y", Progr), Num 0),
		AEq(Var("z", Progr), Mult(Var("x", Progr),Min(Var("y0",Progr), Var("y", Progr)))),
			Seq(Asg("z", Sum(Var("z", Progr), Var("x", Progr))), Asg("a", Min(Var("y", Progr), Num 1)))));;

let downfac =
Seq(Seq(Asg("a", Var("x", Progr)), Asg("y", Num 1)),
	Wh(PNot(PLeq(Var("a", Progr), Num 0)),
		AAnd(AEq(Mult(Var("y", Progr), Fat(Var("a", Progr))), Fat(Var("x", Progr))),AMeq(Var("a", Progr), Num 0)),
			Seq(Asg("y", Mult(Var("y", Progr), Var("a", Progr))), Asg("a", Min(Var("a", Progr), Num 1)))));;
...
print_string "Ex.: (3)\n";;
print_string ((astnTostr (vcgen (AMeq(Var("x", Progr), Num 0)) fat (AEq(Var("y", Progr), Fat(Var("x", Progr)))))) ^ "\n\n");;
...
print_string "Ex.: (6)\n";;
print_string ((astnTostr (vcgen (AAnd(AEq(Var("x", Progr), Var("x0", Progr)), AMeq(Var("x", Progr), Var("x", Progr))))  fat2 (AEq(Var("y", Progr), Fat(Var("x0", Progr)))))) ^ "\n\n");;

print_string "Ex.: (7)\n";;
print_string ((astnTostr (vcgen (AAnd(AEq(Var("x", Progr), Var("x0", Progr)), AMeq(Var("x", Progr), Var("x", Progr))))  sum (AEq(Var("z", Progr), Div(Mult(Var("x0", Progr), Sum(Var("x0", Progr), Num 1)), Num 2))))) ^ "\n\n");;


print_string "Ex.: (8)\n";;
print_string ((astnTostr (vcgen (AMeq(Var("x", Progr), Num 0)) copy1 (AEq(Var("x", Progr), Var("y", Progr))))) ^ "\n\n");;

print_string "Ex.: (9)\n";;
print_string ((astnTostr (vcgen (AMeq(Var("y", Progr), Num 0)) mult1 (AEq(Var("z", Progr), Mult(Var("x", Progr), Var("y", Progr)))))) ^ "\n\n");;

print_string "Ex.: (10)\n";;
print_string ((astnTostr (vcgen (AAnd(AEq(Var("y", Progr), Var("y0", Progr)), AMeq(Var("y", Progr), Num 0))) mult2 (AEq(Var("z", Progr), Mult(Var("x", Progr), Var("y0", Progr)))))) ^ "\n\n");;

print_string "Ex.: (11)\n";;
print_string ((astnTostr (vcgen (AMeq(Var("x", Progr), Num 0)) downfac (AEq(Var("y", Progr), Fat(Var("x", Progr)))))) ^ "\n\n");;
